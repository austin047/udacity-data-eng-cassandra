...
def process_log_file(cur, filepath):  
    ...
    Use the song, artist and length columns from the log data to get song_id and artist_id
    from the song and artist table and use to populate the songplay facts table.
...
def process_data(cur, conn, filepath, func):
    """
    Description: This function is used to read the file in the json files in filepath and
    call func on all the files gotten.

    Arguments:
        cur: the cursor object. 
        conn: database connection
        filepath: dir path.
        func: functions to process data goten from filepath dir
